...
using is_it_hot_in_here.UI;
using UitkForKsp2.API;
using UnityEngine;
using UnityEngine.UIElements;

namespace is_it_hot_in_here;

[BepInPlugin(MyPluginInfo.PLUGIN_GUID, MyPluginInfo.PLUGIN_NAME, MyPluginInfo.PLUGIN_VERSION)]
[BepInDependency(SpaceWarpPlugin.ModGuid, SpaceWarpPlugin.ModVer)]
public class is_it_hot_in_herePlugin : BaseSpaceWarpPlugin
{
    ...
    [PublicAPI] public static is_it_hot_in_herePlugin Instance { get; set; }
    ...
    public override void OnInitialized()
    {
        ...
        var windowOptions = new WindowOptions
        {
            ...
            WindowId = "is_it_hot_in_here_MyFirstWindow",
    ...
    private static void LoadAssemblies()
    {
        ...
        var unityAssembly = Assembly.LoadFrom(Path.Combine(currentFolder, "is_it_hot_in_here.Unity.dll"));
